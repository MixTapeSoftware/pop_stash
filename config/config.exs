...
config :pop_stash, PopStashWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PopStashWeb.ErrorHTML, json: PopStashWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: PopStash.PubSub,
  live_view: [signing_salt: "GFTxH5TD"]
...
config :pop_stash, PopStash.Mailer, adapter: Swoosh.Adapters.Local
