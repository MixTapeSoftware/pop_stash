...
#
#     PHX_SERVER=true bin/pop_stash start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :pop_stash, PopStashWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :pop_stash, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  if mcp_port = System.get_env("MCP_PORT") do
    config :pop_stash, mcp_port: String.to_integer(mcp_port)
  end
  ...
  #
  #     config :pop_stash, PopStash.Mailer,
